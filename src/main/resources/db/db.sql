...
values ('A1', 'Cлабые теоретические знания', 0, 30),
       ('A2', 'Можно дать мини проект как задачу', 30, 44),
       ('B1', 'Может работать в команде, добавим в проект и нужен ментор', 44, 56),
       ('B2', 'Участие во всех встречах команды нужен парт ментор', 56, 70),
       ('C1', 'Может работать в проекте и не нужно ставить ментора', 56, 79),
